...
(function($) {
	...
	api = wpNavMenu = { 
		...
		init : function() {
			api.menuList = $('.menu-to-edit:visible');
		...
		jQueryExtensions : function() {
			...
			$.fn.extend({
				...
				addSelectedToMenu : function(processMethod) {
					if ( 0 === $('.menu-to-edit:visible').length ) {
						return false;
					}
		...
		moveMenuItem : function( $this, dir ) {
			...
			var items, newItemPosition, newDepth,
				menuItems = $( '.menu-to-edit:visible li' ),
		...
		refreshAdvancedAccessibilityOfItem : function( itemToRefresh ) {
			...
			var thisLink, thisLinkText, primaryItems, itemPosition, title,
				...
				totalMenuItems = $('.menu-to-edit:visible li').length,
		...
		refreshKeyboardAccessibility : function() {
			$( 'a.item-edit' ).off( 'focus' ).on( 'focus', function(){
				$(this).off( 'keydown' ).on( 'keydown', function(e){
					...
					if ( 1 === $('.menu-to-edit:visible li').length )
						return;
		...
		initPreviewing : function() {
			...
			$( '.menu-to-edit:visible' ).on( 'change input', '.edit-menu-item-title', function(e) {
		...
		initSortables : function() {
			...
			if( 0 !== $( '.menu-to-edit:visible li' ).length )
			...
			api.menuList.sortable({
				...
				stop: function(e, ui) {
					...
					$(".menu-to-edit:visible .menu-item").each(function (index,element) {
					  $(this).find('.menu-item-data-position').val(index + 1);
					});
		...
		attachUnsavedChangesListener : function() {
			...
			if ( 0 !== $('.menu-to-edit:visible').length || 0 !== $('.menu-location-menus select').length ) {
